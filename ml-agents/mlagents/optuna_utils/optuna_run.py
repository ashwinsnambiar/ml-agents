...
#todo: remove multiple definition of N_EVALUATIONS from here and learn.py
N_EVALUATIONS = 3

def unity_mlagents_param_sampler(trial: optuna.Trial) -> Dict[str, Any]:
    batch_size = 2 ** trial.suggest_int("batch_size", 5, 13)    # 2**13 = 8192 is limit, because GPU maxes out VRAM when run with ~11k batch size.
